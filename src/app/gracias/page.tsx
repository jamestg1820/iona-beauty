  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4">
      ...
      <div className="max-w-3xl w-full bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden">
        <div className="bg-primary p-10 flex flex-col items-center text-center text-gray-800">
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 leading-relaxed max-w-md mx-auto">
              Estamos muy felices de que hayas elegido a <span className="font-bold text-black italic tracking-tighter">IONA BEAUTY</span>. Tu pedido ya está en manos de nuestro equipo de logística.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex gap-4">
              ...
              <div>
                ...
                <div className="mt-3 flex items-center gap-2 text-xs font-bold text-gray-700 bg-primary/30 px-2 py-1 rounded w-fit uppercase tracking-tighter">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              href="/"
              className="w-full sm:w-auto bg-primary text-gray-800 px-10 py-4 rounded-full font-black text-sm tracking-widest hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 shadow-lg shadow-primary/20"
            >
              SEGUIR COMPRANDO
      ...
      <p className="text-gray-400 text-xs mt-12 text-center">
        © {new Date().getFullYear()} IONA BEAUTY - Todos los derechos reservados.<br/>
        Bogotá, Colombia
      </p>
    </div>
  );
