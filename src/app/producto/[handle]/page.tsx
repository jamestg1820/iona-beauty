          ...
          <div className="w-full md:w-2/5 md:sticky md:top-24 self-start">
            <div className="mb-6">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                <div className="flex items-center gap-3 text-2xl">
                  ...
                  <span className={`font-black ${hasDiscount ? 'text-secondary' : 'text-gray-900'}`}>
            ...
            <div className="mt-8">
              <Link 
                ...
                className="block w-full bg-secondary text-white text-center py-4 rounded-full font-bold hover:bg-primary hover:text-gray-800 transition-all uppercase tracking-widest text-xs shadow-lg"
              >
                Ver catálogo
              </Link>
            </div>
