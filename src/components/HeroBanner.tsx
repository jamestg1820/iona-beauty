  ...
  return (
    <div className="relative w-full h-[500px] md:h-[600px] lg:h-[650px] bg-gray-100 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src="/images/iona-hero.png" 
          alt="Nueva Colección IONA BEAUTY" 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-8 h-full">
        ...
        <div className="absolute top-6 left-4 lg:left-8">
          <span className="inline-block py-1.5 px-4 rounded-full bg-accent-mint text-gray-800 text-[10px] md:text-xs font-bold tracking-widest shadow-sm">
            NUEVA COLECCIÓN
          </span>
        </div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-full flex justify-center px-4">
          <Link 
            ...
            className="bg-secondary text-white px-10 py-3.5 md:px-12 md:py-4 rounded-full font-bold hover:bg-black transition-all hover:scale-105 text-center text-sm md:text-base shadow-xl"
          >
            CATÁLOGO
          </Link>
        </div>
