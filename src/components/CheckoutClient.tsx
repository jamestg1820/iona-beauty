        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-4">
            <button 
              ...
              className="w-full flex flex-col items-center justify-center bg-primary text-gray-800 py-3 rounded-full hover:bg-black hover:text-white transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="bg-white p-8 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 sticky top-24">
          ...
          <div className="border-t border-gray-100 pt-4 space-y-3">
            ...
            <div className="flex justify-between items-center pt-3 border-t border-gray-100">
              ...
              <span className="text-2xl font-black text-primary">${subtotal.toLocaleString('es-CO')}</span>
            </div>
          </div>
