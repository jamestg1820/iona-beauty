...
const mockProducts: UIProduct[] = [
  { id: '1', handle: 'serum-facial-vitamina-c', name: 'Serum Facial Vitamina C + Ácido Hialurónico', price: 89900, originalPrice: 110900, image: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=400&q=80', badge: 'MÁS VENDIDO' },
  { id: '2', handle: 'crema-hidratante-noche', name: 'Crema Hidratante de Noche Reparadora', price: 75900, originalPrice: undefined, image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=400&q=80', badge: 'NUEVO' },
  { id: '3', handle: 'exfoliante-corporal-coco', name: 'Exfoliante Corporal Coco & Karité', price: 45000, originalPrice: undefined, image: 'https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?auto=format&fit=crop&w=400&q=80', badge: undefined },
  { id: '4', handle: 'mascarilla-arcilla-rosa', name: 'Mascarilla Facial Arcilla Rosa Purificante', price: 38000, originalPrice: 45000, image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?auto=format&fit=crop&w=400&q=80', badge: '-15%' },
];
            ...
            <div key={`${product.id}-${index}`} className="min-w-[280px] w-[85vw] sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] flex-shrink-0 snap-start bg-white border border-gray-100 rounded-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden group/card flex flex-col relative">
              <Link href={`/producto/${product.handle}`} className="flex flex-col h-full">
                <div className="relative aspect-[4/5] bg-gray-50 overflow-hidden">
                  {product.badge && (
                    <div className="absolute top-3 left-3 bg-primary text-gray-800 text-[10px] font-bold px-2.5 py-1 z-10 tracking-wider">
                      {product.badge}
                    </div>
                  )}
                  <img 
                ...
                <div className="p-5 flex flex-col flex-grow">
                  <h3 className="font-semibold text-gray-800 group-hover/card:text-primary transition-colors mb-2 line-clamp-2 min-h-[48px]">
                    {product.name}
                  </h3>
              ...
              <div className="absolute top-0 left-0 right-0 aspect-[4/5] pointer-events-none overflow-hidden">
                <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-[120%] group-hover/card:translate-y-0 transition-transform duration-300 ease-in-out z-20 pointer-events-auto">
                  <button 
                    ...
                    className="w-full bg-primary text-gray-800 py-3 rounded font-bold hover:bg-black hover:text-white transition-colors flex items-center justify-center shadow-lg"
                  >
