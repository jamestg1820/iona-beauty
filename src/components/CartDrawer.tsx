          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 flex flex-col">
              {items.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center">
                  ...
                  <button 
                    onClick={closeCart}
                    className="bg-primary text-gray-800 px-8 py-3 rounded-full font-bold hover:bg-black hover:text-white transition-colors"
                  >
                    Seguir Comprando
                  </button>
                </div>
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50">
              ...
              <button 
                ...
                className="w-full flex flex-col items-center justify-center bg-primary text-gray-800 py-3 rounded-full hover:bg-black hover:text-white transition-all duration-300 shadow-sm active:scale-[0.98] mb-3"
              >
              ...
              <button 
                onClick={closeCart}
                className="w-full py-3 rounded-full border-2 border-gray-100 text-gray-400 font-bold text-xs tracking-[0.2em] hover:border-primary hover:text-primary transition-all duration-300 flex items-center justify-center gap-2 group"
              >
